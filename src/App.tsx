  ...
  return (
    <div className="app-shell">
      <aside className={mobileOpen ? 'app-sidebar open' : 'app-sidebar'}>
        ...
        <div className="side-profile"><span>M1</span><div><strong>Member 1</strong><small>Personal workspace</small></div><MoreHorizontal /></div>
      </aside>
      <div className="app-main">
        <header className="app-topbar">
          ...
          <div className="top-actions"><button className="search-button"><Search size={16}/><span>Search</span><kbd>⌘ K</kbd></button><ThemeButton theme={theme} setTheme={setTheme}/><button className="icon-button notification"><Bell size={18}/><i /></button><button className="avatar">M1</button></div>
        </header>
...
function Forecast() {
  ...
  // interactive in Increment 1. Member 4's model will provide these values later.
